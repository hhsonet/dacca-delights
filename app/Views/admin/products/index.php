            ...
            <span style="position:relative;display:block;width:44px;height:44px">
              ...
              <span title="<?= $isAi ? 'AI-generated image' : 'Real photograph' ?>"
                    style="position:absolute;right:-4px;bottom:-4px;width:17px;height:17px;border-radius:999px;
                           ...
                           background:<?= $isAi ? '#9E1C60' : '#17693F' ?>"><?php if ($isAi): ?>✦<?php else: ?><svg viewBox="0 0 512 512" fill="currentColor" width="9" height="9" aria-hidden="true" style="display:block"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg><?php endif; ?></span>
            </span>
          <?php else: ?>
