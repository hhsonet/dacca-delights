...
<sc-if value="{{ sg.showOrigin }}" hint-placeholder-val="{{ false }}"><span title="{{ sg.originTitle }}" style="position:absolute; right:-3px; bottom:-3px; width:15px; height:15px; border-radius:999px; border:2px solid #FFFFFF; background:{{ sg.originBg }}; color:#FFFFFF; font-size:8px; font-weight:700; display:flex; align-items:center; justify-content:center; line-height:1"><sc-if value="{{ sg.isAi }}" hint-placeholder-val="{{ false }}"><span style="line-height:1">✦</span></sc-if><sc-if value="{{ sg.isReal }}" hint-placeholder-val="{{ true }}"><svg viewBox="0 0 512 512" fill="currentColor" width="9" height="9" aria-hidden="true" focusable="false" style="display:block; flex:none"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg></sc-if></span></sc-if></span>
