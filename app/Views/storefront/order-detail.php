      ...
      <div style="background:#FFFFFF; border:1px solid #EADFE2; border-radius:24px; padding:22px; display:flex; flex-direction:column; gap:14px">
        ...
        <sc-for list="{{ od.items }}" as="it" hint-placeholder-count="3">
          <div style="display:flex; gap:14px; align-items:center; padding-bottom:12px; border-bottom:1px solid #EADFE2">
            <span style="position:relative; flex:none; display:block"><img src="{{ it.image }}" alt="{{ it.name }}" loading="lazy" style="width:60px; height:60px; border-radius:14px; object-fit:cover; flex:none"><sc-if value="{{ it.showOrigin }}" hint-placeholder-val="{{ false }}"><span title="{{ it.originTitle }}" style="position:absolute; right:-3px; bottom:-3px; width:16px; height:16px; border-radius:999px; border:2px solid #FFFFFF; background:{{ it.originBg }}; color:#FFFFFF; display:flex; align-items:center; justify-content:center; line-height:1"><sc-if value="{{ it.isAi }}" hint-placeholder-val="{{ false }}"><svg viewBox="0 0 512 512" width="9" height="9" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M256 40q40 176 216 216-176 40-216 216-40-176-216-216 176-40 216-216Z" fill="currentColor"/></svg></sc-if><sc-if value="{{ it.isReal }}" hint-placeholder-val="{{ true }}"><svg viewBox="0 0 512 512" fill="currentColor" width="9" height="9" aria-hidden="true" focusable="false" style="display:block; flex:none"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg></sc-if></span></sc-if></span>
