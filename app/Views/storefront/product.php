            ...
            <sc-for list="{{ detail.thumbs }}" as="t" hint-placeholder-count="3">
              <button onClick="{{ t.select }}" aria-label="{{ t.alt }}" style="position:relative; aspect-ratio:1/1; border-radius:14px; overflow:hidden; background:#F3E7D6; padding:0; cursor:pointer; display:block; border:2px solid {{ t.border }}; transition:border-color 160ms ease">
                ...
                <sc-if value="{{ t.showOrigin }}" hint-placeholder-val="{{ false }}">
                  <span title="{{ t.originTitle }}" style="position:absolute; right:4px; bottom:4px; background:{{ t.originBg }}; color:#FFFFFF; border-radius:999px; display:inline-flex; align-items:center; padding:3px"><sc-if value="{{ t.isAi }}" hint-placeholder-val="{{ false }}"><svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M3 8.5V3h5.5"/><path d="M15.5 3H21v5.5"/><path d="M21 15.5V21h-5.5"/><path d="M8.5 21H3v-5.5"/><path d="M13.6 9.1q1.05 3.45 4.5 4.5-3.45 1.05-4.5 4.5-1.05-3.45-4.5-4.5 3.45-1.05 4.5-4.5Z"/><path d="M8.5 5.9q.5 1.7 2.2 2.2-1.7.5-2.2 2.2-.5-1.7-2.2-2.2 1.7-.5 2.2-2.2Z"/></svg></sc-if><sc-if value="{{ t.isReal }}" hint-placeholder-val="{{ true }}"><svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M3 8.5V3h5.5"/><path d="M15.5 3H21v5.5"/><path d="M21 15.5V21h-5.5"/><path d="M8.5 21H3v-5.5"/><path d="M12 8.4v7.2"/><path d="M8.4 12h7.2"/></svg></sc-if></span>
                </sc-if>
              </button>
            </sc-for>
          </div>
