        ...
        <div style="display:flex; flex-direction:column; gap:12px">
          <div style="position:relative; aspect-ratio:1/1; border-radius:28px; overflow:hidden; background:#F3E7D6">
            ...
            <sc-if value="{{ detail.showOrigin }}" hint-placeholder-val="{{ false }}">
              <span title="{{ detail.originTitle }}" style="position:absolute; right:14px; bottom:14px; background:{{ detail.originBg }}; color:#FFFFFF; font-size:11px; font-weight:700; border-radius:999px; display:inline-flex; align-items:center; gap:5px; padding:6px 13px"><sc-if value="{{ detail.isAi }}" hint-placeholder-val="{{ false }}"><svg viewBox="0 0 512 512" width="12" height="12" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M432 268V152a72 72 0 0 0-72-72H152a72 72 0 0 0-72 72v208a72 72 0 0 0 72 72h140" fill="none" stroke="currentColor" stroke-width="46" stroke-linecap="round" stroke-linejoin="round"/><path d="M168 336l46-146 46 146M182 296h64" fill="none" stroke="currentColor" stroke-width="30" stroke-linecap="round" stroke-linejoin="round"/><path d="M316 190v146" fill="none" stroke="currentColor" stroke-width="30" stroke-linecap="round"/><path d="M404 292q16 80 104 104-88 24-104 104-16-80-104-104 88-24 104-104Z" fill="currentColor"/></svg></sc-if><sc-if value="{{ detail.isReal }}" hint-placeholder-val="{{ true }}"><svg viewBox="0 0 512 512" fill="currentColor" width="11" height="11" aria-hidden="true" focusable="false" style="display:block; flex:none"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg></sc-if><span>{{ detail.originWord }}</span></span>
            </sc-if>
          </div>
