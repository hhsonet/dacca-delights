        ...
        <div style="display:flex; flex-direction:column; gap:12px">
          <div style="position:relative; aspect-ratio:1/1; border-radius:28px; overflow:hidden; background:#F3E7D6">
            ...
            <sc-if value="{{ detail.showOrigin }}" hint-placeholder-val="{{ false }}">
              <sc-if value="{{ detail.isAi }}" hint-placeholder-val="{{ false }}"><span title="{{ detail.originTitle }}" style="position:absolute; right:14px; bottom:14px; display:inline-flex; align-items:center; gap:7px; padding:6px 12px 6px 10px; border-radius:999px; border:1px solid rgba(255,255,255,0.85); background:rgba(43,23,31,0.42); backdrop-filter:blur(6px); color:#FFFFFF; font-size:12px; font-weight:600; letter-spacing:0.01em; white-space:nowrap"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M3 8.4V5a2 2 0 0 1 2-2h3.4"/><path d="M15.6 3H19a2 2 0 0 1 2 2v3.4"/><path d="M21 15.6V19a2 2 0 0 1-2 2h-3.4"/><path d="M8.4 21H5a2 2 0 0 1-2-2v-3.4"/><path d="M13.6 9.1q1.05 3.45 4.5 4.5-3.45 1.05-4.5 4.5-1.05-3.45-4.5-4.5 3.45-1.05 4.5-4.5Z"/><path d="M8.5 5.9q.5 1.7 2.2 2.2-1.7.5-2.2 2.2-.5-1.7-2.2-2.2 1.7-.5 2.2-2.2Z"/></svg><span>AI-gen Image</span></span></sc-if><sc-if value="{{ detail.isReal }}" hint-placeholder-val="{{ true }}"><span title="{{ detail.originTitle }}" style="position:absolute; right:14px; bottom:14px; border-radius:999px; display:inline-flex; align-items:center; justify-content:center; padding:6px; background:{{ detail.originBg }}; color:#FFFFFF"><svg viewBox="0 0 512 512" fill="currentColor" width="13" height="13" aria-hidden="true" focusable="false" style="display:block; flex:none"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg></span></sc-if>
            </sc-if>
          </div>
            ...
            <sc-for list="{{ detail.thumbs }}" as="t" hint-placeholder-count="3">
              <button onClick="{{ t.select }}" aria-label="{{ t.alt }}" style="position:relative; aspect-ratio:1/1; border-radius:14px; overflow:hidden; background:#F3E7D6; padding:0; cursor:pointer; display:block; border:2px solid {{ t.border }}; transition:border-color 160ms ease">
                ...
                <sc-if value="{{ t.showOrigin }}" hint-placeholder-val="{{ false }}">
                  <span title="{{ t.originTitle }}" style="position:absolute; right:4px; bottom:4px; background:{{ t.originBg }}; color:#FFFFFF; border-radius:999px; display:inline-flex; align-items:center; padding:3px"><sc-if value="{{ t.isAi }}" hint-placeholder-val="{{ false }}"><svg viewBox="0 0 512 512" width="12" height="12" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M432 268V152a72 72 0 0 0-72-72H152a72 72 0 0 0-72 72v208a72 72 0 0 0 72 72h140" fill="none" stroke="currentColor" stroke-width="46" stroke-linecap="round" stroke-linejoin="round"/><path d="M168 336l46-146 46 146M182 296h64" fill="none" stroke="currentColor" stroke-width="30" stroke-linecap="round" stroke-linejoin="round"/><path d="M316 190v146" fill="none" stroke="currentColor" stroke-width="30" stroke-linecap="round"/><path d="M404 292q16 80 104 104-88 24-104 104-16-80-104-104 88-24 104-104Z" fill="currentColor"/></svg></sc-if><sc-if value="{{ t.isReal }}" hint-placeholder-val="{{ true }}"><svg viewBox="0 0 512 512" fill="currentColor" width="11" height="11" aria-hidden="true" focusable="false" style="display:block; flex:none"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg></sc-if></span>
                </sc-if>
              </button>
            </sc-for>
          </div>
