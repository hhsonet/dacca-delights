          ...
          <article style="background:#FFFFFF; border:1px solid #EADFE2; border-radius:24px; overflow:hidden; display:flex; flex-direction:column; transition:transform 220ms ease, box-shadow 220ms ease" style-hover="transform:translateY(-4px); box-shadow:0 18px 42px rgba(86,21,48,0.14)">
            <button onClick="{{ p.open }}" style="position:relative; display:block; border:0; padding:0; cursor:pointer; background:#F3E7D6; aspect-ratio:1/1; overflow:hidden">
              ...
              <sc-if value="{{ p.showOrigin }}" hint-placeholder-val="{{ false }}">
                <sc-if value="{{ p.isAi }}" hint-placeholder-val="{{ false }}"><span title="{{ p.originTitle }}" style="position:absolute; right:12px; bottom:12px; display:inline-flex; align-items:center; gap:7px; padding:6px 12px 6px 10px; border-radius:999px; border:1px solid rgba(255,255,255,0.85); background:rgba(43,23,31,0.42); backdrop-filter:blur(6px); color:#FFFFFF; font-size:11.5px; font-weight:600; letter-spacing:0.01em; white-space:nowrap"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="display:block; flex:none"><path d="M3 8.4V5a2 2 0 0 1 2-2h3.4"/><path d="M15.6 3H19a2 2 0 0 1 2 2v3.4"/><path d="M21 15.6V19a2 2 0 0 1-2 2h-3.4"/><path d="M8.4 21H5a2 2 0 0 1-2-2v-3.4"/><path d="M13.6 9.1q1.05 3.45 4.5 4.5-3.45 1.05-4.5 4.5-1.05-3.45-4.5-4.5 3.45-1.05 4.5-4.5Z"/><path d="M8.5 5.9q.5 1.7 2.2 2.2-1.7.5-2.2 2.2-.5-1.7-2.2-2.2 1.7-.5 2.2-2.2Z"/></svg><span>AI-gen Image</span></span></sc-if><sc-if value="{{ p.isReal }}" hint-placeholder-val="{{ true }}"><span title="{{ p.originTitle }}" style="position:absolute; right:12px; bottom:12px; border-radius:999px; display:inline-flex; align-items:center; justify-content:center; padding:6px; background:{{ p.originBg }}; color:#FFFFFF"><svg viewBox="0 0 512 512" fill="currentColor" width="12" height="12" aria-hidden="true" focusable="false" style="display:block; flex:none"><path fill-rule="evenodd" d="M195.8 61h120.4a64 64 0 0 1 53.3 28.6L395.1 128H448a64 64 0 0 1 64 64v192a64 64 0 0 1-64 64H64a64 64 0 0 1-64-64V192a64 64 0 0 1 64-64h52.9l25.6-38.4A64 64 0 0 1 195.8 61ZM256 176a112 112 0 1 0 0 224 112 112 0 0 0 0-224Zm168-16a16 16 0 0 0 0 32h24a16 16 0 0 0 0-32h-24Z"/><circle cx="256" cy="288" r="64"/></svg></span></sc-if>
              </sc-if>
            </button>
            <div style="padding:16px; display:flex; flex-direction:column; gap:8px; flex:1">
              ...
              <span style="display:flex; align-items:center; gap:6px; flex-wrap:wrap"><span style="background:#FDF3DF; color:#8A5A08; border-radius:6px; padding:3px 7px; font-size:10.5px; font-weight:700; white-space:nowrap">{{ p.kcal }}</span><sc-if value="{{ p.hasMin }}" hint-placeholder-val="{{ false }}"><span title="This item is sold in a minimum quantity" style="background:#F1E3EA; color:#9E1C60; border-radius:6px; padding:3px 7px; font-size:10.5px; font-weight:700; white-space:nowrap">{{ p.minNote }}</span></sc-if></span>
